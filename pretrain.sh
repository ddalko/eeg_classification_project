...
# ATCNet pretraining with session 1,2 data (same as EEGNet pretraining configuration)
python main.py --mode=pretrain --load_all --net=ATCNet --band=0,40 --label=0,1,2,3 --gpu=0 --sch=cos --eta_min=0 --epoch=500 -lr=2e-3 --stamp=241129_ATCNet_pretrained --seed=42 --batch_size=576 -wd=2e-3 --train_subject=1 --criterion=FOCAL 